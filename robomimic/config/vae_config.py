...
class VAEConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        # Sample Weights
        self.algo.sample_weights.use_sample_weight = False
        self.algo.sample_weights.weight_key = ""
        self.algo.sample_weights.mixed_weights = False
        self.algo.sample_weights.use_adv_score = False

        self.algo.sample_weights.demos = 1
        self.algo.sample_weights.rollouts = 1
        self.algo.sample_weights.intvs = 1
        self.algo.sample_weights.pre_intvs = 0.1

        self.algo.sample_weights.traj_label_type = "last"

        self.algo.sample_weights.batch_normalize = True
